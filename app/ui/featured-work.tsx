        ...
        <div className="max-w-[1280px] mx-auto">
          ...
          <div className="space-y-28">
            <article className="flex flex-col gap-6">
              ...
              <div className="space-y-4 flex flex-col justify-center max-w mx-auto">
                <h3 className={`${mada.className} text-3xl sm:text-4xl font-black text-neutral-200 uppercase`}>
