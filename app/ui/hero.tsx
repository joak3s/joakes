...
export default function Hero() {
  ...
  return (
    <>
      ...
      <div className="absolute left-0 right-0 w-screen h-[140vh] overflow-hidden">
        {/* Gradient Circle */}
        <div 
          className="absolute left-1/2 top-[45vh] -translate-x-1/2 w-[280px] sm:w-[400px] md:w-[600px] h-[200px] sm:h-[300px] md:h-[400px] opacity-15 bg-white rounded-full blur-[80px] sm:blur-[100px] md:blur-[120px]"
        />
      </div>
      ...
      <section className="relative w-full px-4 sm:px-6 lg:px-16 pt-24 md:pt-28 pb-16 flex flex-col items-center gap-6 md:gap-16">
        <div className="relative z-10 w-full max-w-4xl mx-auto text-center py-8">
          <h1 className="text-3xl md:text-4xl lg:text-5xl font-black font-mada text-white leading-tight tracking-tight mb-4 [text-shadow:_0px_4px_2px_rgb(0_0_0_/_0.20)]">
            I'm Jordan Oakes, a<br/>UX Designer and AI Specialist
          </h1>
          <p className="text-lg md:text-xl lg:text-2xl text-gray-200 font-light font-roboto">
        ...
        <div className="relative z-10 w-full max-w-2xl px-4">
            ...
            <div className="space-y-4">
              <div className="relative">
                <input
                  ...
                  className="w-full min-h-[4rem] px-4 py-3 bg-zinc-950 rounded-2xl shadow-[0px_0px_5px_0px_rgba(255,255,255,0.07)] border border-neutral-800 text-neutral-400 text-base md:text-lg font-normal font-roboto placeholder:text-neutral-400 focus:outline-none focus:border-neutral-700 transition-colors"
                />
              </div>
              ...
              <div className="hidden md:flex items-center justify-between gap-4">
                <button 
                  type="button" 
                  className="px-5 py-3 rounded-full border border-neutral-700 text-stone-300 text-base font-roboto hover:bg-neutral-800 transition-colors"
                >
                  Case Studies
                </button>
                <button 
          ...
          <div className="flex flex-wrap gap-2 mt-4 md:hidden">
            {promptButtons.map((button, index) => (
              ...
              >
                <span className="text-stone-300 text-base font-normal font-roboto">
                  {button.text}
                </span>
              </button>
            ))}
